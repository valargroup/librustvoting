...
use super::{
    derivation::keyed_hash64, BundleMaterialSourceV1, VotingAuthorityRootV1,
...
pub struct RecoverableBundleUseV1<'a> {
    ...
    authority_selection: &'a VotingAuthoritySelectionV1,
    current_round: &'a VerifiedRoundAuthV3,
