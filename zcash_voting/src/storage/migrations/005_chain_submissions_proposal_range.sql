-- v21 rebuilds `chain_submissions` so its proposal bound is the 50-proposal
...
-- version 20. Nothing rewrites it, and the version-20 schema fingerprint turns
...
INSERT INTO chain_submissions SELECT * FROM chain_submissions_v20;
DROP TABLE chain_submissions_v20;
