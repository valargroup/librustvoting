...
- Aligned the Ironwood crate line on `voting-circuits 0.9.0-rc.2`,
  `pir-client 0.4.0-rc.1`, `pir-types 0.3.0-rc.1`, and a pinned librustzcash
  revision containing Ironwood historical note selection. PIR clients require
  Ironwood dataset version 1 from `/root`, wallet integrations resolve one
  shielded/PCZT stack, vote tree storage APIs use `shardtree 0.7`, and the
  wallet crates require Rust 1.88 or newer.
